...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = '/web/libs/common/ueditor/';//window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://www.wiz.cn"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
